...
public class JwtAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
    ...
    refreshTokenService.merge((String) authentication.getPrincipal(), jwtRefreshToken);
  ...
  private void setBodyTokenDto(HttpServletResponse response, String tokenType, String accessToken, String refreshToken)
      throws IOException {
    // body -> Token Dto
